...
<head>
    ...
    <link rel="shortcut icon" href="Admin Dashboard/img/favicon.svg" />
    ...
    <link rel="stylesheet" href="Admin Dashboard/fonts/style.css">
    <!-- Main css -->
    <link rel="stylesheet" href="Admin Dashboard/css/main.css">
    <!-- Chat css -->
    <link rel="stylesheet" href="Admin Dashboard/css/chat.css">
...
<body>
    ...
    <div class="page-wrapper sidebar-mini">
        ...
        <nav id="sidebar" class="sidebar-wrapper">
            ...
            <div class="sidebar-brand">
                ...
                <a href="index.html" class="logo">
                    <img src="Admin Dashboard/img/logo.svg" alt="Bootstrap Gallery">
                </a>
            </div>
            <!-- Sidebar brand end  -->
            ...
            <div class="sidebar-user-details">
                <div class="user-profile">
                    <img src="Admin Dashboard/img/user2.png" class="profile-thumb" alt="Admin Dashboards">
        ...
        <div class="page-content">
                    ...
                    <ul class="header-actions">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="user-img away">
                                                <img src="Admin Dashboard/img/user6.png" alt="Admin Template">
                                            </div>
                                            <div class="details">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="user-img busy">
                                                <img src="Admin Dashboard/img/user13.png"
                                                    alt="Premium Admin Dashboards">
                                            </div>
                                            <div class="details">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="user-img online">
                                                <img src="Admin Dashboard/img/user19.png"
                                                    alt="Premium Admin Dashboards">
                                            </div>
                                            <div class="details">
                            ...
                            <div class="dropdown-menu dropdown-menu-right lrg" aria-labelledby="notifications">
                                ...
                                <ul class="header-notifications">
                                    <li>
                                        <a href="#">
                                            <div class="user-img away">
                                                <img src="Admin Dashboard/img/user10.png" alt="Bootstrap Admin Panel">
                                            </div>
                                            <div class="details">
                                                <div class="user-title">Abbott</div>
                                                <div class="noti-details">Membership has been ended.</div>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="user-img busy">
                                                <img src="Admin Dashboard/img/user10.png" alt="Admin Panel">
                                            </div>
                                            <div class="details">
                                                <div class="user-title">Braxten</div>
                                                <div class="noti-details">Approved new design.</div>
                        ...
                        <li class="dropdown user-settings">
                            <a href="#" id="userSettings" data-toggle="dropdown" aria-haspopup="true">
                                <img src="Admin Dashboard/img/user2.png" class="user-avatar" alt="Top Admin Dashboards">
                            </a>
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userSettings">
                                <div class="header-profile-actions">
                                    <div class="header-user-profile">
                                        <div class="header-user">
                                            <img src="Admin Dashboard/img/user2.png" alt="Admin Template">
                                        </div>
                                        <h5>Yuki Hayashi</h5>
                                        <p>Super User</p>
                                    </div>
            ...
            <div class="main-container">
                ...
                <div class="page-header">
                    ...
                    <!-- Breadcrumb start -->
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">Welcome, Hayashi</li>
                    </ol>
                    <!-- Breadcrumb end -->
                                ...
                                <div class="row gutters align-items-center">
                                    <div class="col-xl-2 col-lg-3 col-sm-12 col-12">
                                        <div class="monthly-avg">
                                            <h5>Weekly</h5>
                                            <div class="avg-block">
                                                <h3 class="avg-total text-danger">25k</h3>
                                    ...
                                    <div class="col-xl-8 col-lg-6 col-sm-12 col-12">
                                    ...
                                    <div class="col-xl-2 col-lg-3 col-sm-12 col-12">
                                        <div class="monthly-avg">
                                            <h5>Monthly</h5>
                                            <div class="avg-block">
                                                <h3 class="avg-total text-danger">31k</h3>
                                                <h6 class="avg-label">Sales</h6>
                                            </div>
                                            <div class="avg-block">
                    ...
                    <div class="col-xl-4 col-lg-6 col-sm-12 col-12">
                        <div class="card">
                            <div class="payments-card">
                                <h6>Balance</h6>
                                <h4 class="text-success">$5699.89</h4>
                                ...
                                <div class="customScroll5">
                                    <div class="timeline-activity">
                                        <div class="activity-log">
                                            <p class="log-name">Corey Haggard<small class="log-time">- 9 mins
                                                    ago</small></p>
                                            <div class="log-details">Tycoon dashboard has been created<span
                                                    class="text-info ml-1">#New</span></div>
                                        </div>
                                        <div class="activity-log">
                                            <p class="log-name">Gleb Kuznetsov<small class="log-time">- 4 hrs
                                                    ago</small></p>
                                            <div class="log-details">
                                                Farewell day photos uploaded.
                                                <div class="stacked-images mt-1">
                                                    <img class="sm" src="Admin Dashboard/img/user.png"
                                                        alt="Google Admin Dashboards">
                                                    <img class="sm" src="Admin Dashboard/img/user2.png"
                                                        alt="Google Admin Dashboards">
                                                    <img class="sm" src="Admin Dashboard/img/user3.png"
                                                        alt="Google Admin Dashboards">
                                                    <img class="sm" src="Admin Dashboard/img/user4.png"
                                                        alt="Google Admin Dashboards">
                                        ...
                                        <div class="activity-log">
                                            <p class="log-name">Yuki Hayashi<small class="log-time">- 7 hrs ago</small>
                                            </p>
                                            <div class="log-details">Developed 30 multipurpose Bootstrap 4 Admin
                                                Templates</div>
                                        </div>
                                        <div class="activity-log">
                                        ...
                                        <div class="activity-log">
                                            ...
                                            <div class="log-details">
                                                Farewell day photos uploaded.
                                                <div class="stacked-images mt-1">
                                                    <img class="sm" src="Admin Dashboard/img/user5.png"
                                                        alt="Google Admin Dashboards">
                                                    <img class="sm" src="Admin Dashboard/img/user22.png"
                                                        alt="Google Admin Dashboards">
                                        ...
                                        <div class="activity-log">
                                            <p class="log-name">Nkio Toyoda<small class="log-time">- 3 hrs ago</small>
                                            </p>
                                            <div class="log-details">Developed 30 multipurpose Bootstrap 4 Admin
                                                Templates</div>
                                        </div>
                                    ...
                                    <div class="products-sold-container">
                                        <div class="product">
                                            <div class="product-details">
                                                <img src="Admin Dashboard/img/mobiles/mob1.jpg" alt="Google Dashboard">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <img src="Admin Dashboard/img/mobiles/mob2.jpg" alt="Google Dashboard">
                                                <div class="product-title">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <img src="Admin Dashboard/img/mobiles/mob3.jpg" alt="Google Dashboard">
                                                <div class="product-title">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <img src="Admin Dashboard/img/mobiles/mob4.jpg" alt="Google Dashboard">
                                                <div class="product-title">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <img src="Admin Dashboard/img/mobiles/mob5.jpg" alt="Google Dashboard">
                                                <div class="product-title">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <img src="Admin Dashboard/img/mobiles/mob6.jpg" alt="Google Dashboard">
                                                <div class="product-title">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <img src="Admin Dashboard/img/mobiles/mob7.jpg" alt="Google Dashboard">
                                                <div class="product-title">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <img src="Admin Dashboard/img/mobiles/mob8.jpg" alt="Google Dashboard">
                                                <div class="product-title">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="upgrade-account">
                                        ...
                                        <div class="custom-btn-group mt-2">
                                            <a href="pricing.html" class="btn btn-success ml-0"><i
                                                    class="icon-trending-up"></i>Upgrade</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div id="chat-box">
                <div id="chat-circle" class="btn btn-raised">
                    <img src="Admin Dashboard/img/chat.svg" alt="Best Google Dashboards" />
                </div>
                <div class="chat-box">
                    ...
                    <div class="chat-box-body">
                        <div class="chat-logs">
                            <div class="chat-msg self">
                                <img src="Admin Dashboard/img/user2.png" class="user" alt="Google Dashboards">
                                <div class="chat-msg-text">Hello</div>
                            </div>
                            <div class="chat-msg user">
                                <img src="Admin Dashboard/img/user15.png" class="user" alt="Google Dashboards">
    ...
    <script src="Admin Dashboard/js/moment.js"></script>
    ...
    <!-- *************
		...
		************* -->
    <!-- Slimscroll JS -->
    <script src="Admin Dashboard/vendor/slimscroll/slimscroll.min.js"></script>
    <script src="Admin Dashboard/vendor/slimscroll/custom-scrollbar.js"></script>

    <!-- Polyfill JS -->
    <script src="Admin Dashboard/vendor/polyfill/polyfill.min.js"></script>
    <script src="Admin Dashboard/vendor/polyfill/class-list.min.js"></script>
    ...
    <script src="Admin Dashboard/vendor/peity/custom-peity.js"></script>

    <!-- Circleful Charts -->
    <script src="Admin Dashboard/vendor/circliful/circliful.min.js"></script>
    <script src="Admin Dashboard/vendor/circliful/circliful.custom.js"></script>
